...
1. AMI_chunks_v4    #text and audio for AMI corpus of 10s segments
>> train, valid, test subfolders
>> >> .wav .txt file pairs (EN2001a_0000_0010_2.wav;EN2001a_0000_0010_script.txt) 'AMI meeting name_meeting starttime_meeting endtime_number of speaker' 
...
>> >> corresponding speech transcription .txt file found in AMI_chunks_v4 under the same meeting naming format: 'AMI meeting_meeting starttime_metting endtime'
...
5. data_creation.py # python script for getting AMI_chunks data. processing AMI corpus into 10s segments and extracting transcript
